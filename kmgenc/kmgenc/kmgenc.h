...
/* Get parse errors using this (see PACK1555 static int function below for the fix)
...
static inline int PACK1555(float a, float r, float g, float b) {
    int i = 0x0000;   
    if(a) { i = 0x8000; }
    return (i | ((int)(r*31) << 10) | ((int)(g*31) << 5) | ((int)(b*31) << 0));
}
